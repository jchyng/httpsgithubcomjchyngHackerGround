...
public class JobCompanyService {
    ...
    public boolean crawlingTask() {
        ...
        Elements aTags = doc.select(".pagination button");

        for (Element aTag : aTags) {
            String indexStr = aTag.text();
        ...
        while (true) {
            ...
            if(pageIndex > maxPageIndex)
                ...
                nextPageButton = driver.findElement(By.xpath(("//button[@class='page_num on' and contains(text(), '" + pageIndex + "')]")));
